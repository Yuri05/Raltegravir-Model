...
qualificationRunnerFolder = 'C:\OSPQualification\QualificationRunner8.0.51';
markdownJoinerFolder = 'C:\OSPQualification\Markdownjoiner1.1.0\';
% --------------------------------------------------------------
...
MarkdownJoiner_path=fullfile('C:\OSPQualification\Markdownjoiner1.1.0.1\markdown-joiner.exe');
